    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {//////////////////////////////////////////////////////
                ...
                //TODO
                List<string> str = new List<string> { "1qwerty", "cqwertyc", "cqwe", "c", "gc", "xc"};
            ...
            {//////////////////////////////////////////////////////
                ...
                //TODO
                int K = 5;
                List<string> str = new List<string> { "1QUS5", "AS45A", "1AAA1", "fsdf9", "gc2", "xc8" };
                List<string> str2 = str.Where(x => x.Length == K)
                    .Where(x => Int32.TryParse(x.Substring(K - 1, 1), out _))
                    .OrderBy(x => x.Substring(K-1,1)).ToList();
            }
            ...
            {//////////////////////////////////////////////////////
                ...
                int k = 8, d = 5;
                IEnumerable<int> n = new int[] {  1, 3, 5, 4, 6, 6, 2, 5, 8, 9, 0, 90, 12, 88, };
            ...
            {//////////////////////////////////////////////////////
                ...
                //TODO
                List<string> str = new List<string> { "asdbvc", "qwsxdfsdg", "jhgsdfegt", "tygbg", "gfgf", "jk" };
            ...
            {//////////////////////////////////////////////////////
             ...
             //а для совпадающих чисел — по возрастанию номера года.
                ...
                //TODO
                List<SchoolData> schools = new List<SchoolData> { new SchoolData(5, 2006, "Vasilienko"), new SchoolData(5, 2006, "Ivanov"), new SchoolData(33, 2008, "Kudakov"), new SchoolData(1, 2008, "Jordan"), new SchoolData(3, 2006, "Portnyagin"), new SchoolData(6, 2006, "ASD"), new SchoolData(1, 2009, "Lavin"), new SchoolData(4, 2009, "Petrov") };
                //Action<> write = schoolData => {  };
